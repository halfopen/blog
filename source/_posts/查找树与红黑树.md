...
categories:
  - 面试
date: 2017-12-16 19:58:00
---
## 平衡查找树


![upload successful](\assets\images\查找树与红黑树\pasted-0.png)
...
![upload successful](\assets\images\查找树与红黑树\pasted-1.png)

由上图可以很明显的看到红黑树可以完全代替2-3树，下面给出红黑树的定义：
![upload successful](\assets\images\查找树与红黑树\pasted-2.png)
...
![upload successful](\assets\images\查找树与红黑树\pasted-3.png)
因为右链接不能为红色，旋转后
![upload successful](\assets\images\查找树与红黑树\pasted-4.png)
...
![upload successful](\assets\images\查找树与红黑树\pasted-5.png)

![upload successful](\assets\images\查找树与红黑树\pasted-6.png)
